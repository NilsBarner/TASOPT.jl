...
output_csv(example_ac, "example_output_cryo.csv")

###
xw, yw, zw = compile_wingbox_coordinates(example_ac)
df = DataFrame(xw = xw, yw = yw, zw = zw)
CSV.write("wingbox_coordinates.csv", df)
###
