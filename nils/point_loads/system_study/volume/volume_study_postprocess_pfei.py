...
for packing_idx in [0, 1]:
    ...
    ax.scatter(pareto_front_sorted[:,0][np.argmin(pareto_front_sorted[:,1])], np.min(pareto_front_sorted[:,1]), color=colors[0], edgecolor='none')
    ...
    min_idx = np.argmin(pareto_front_sorted[:,1])
    xmin, ymin = pareto_front_sorted[:,0][min_idx], np.min(pareto_front_sorted[:,1])
    ax.scatter(xmin, ymin, color=colors[1], alpha=alpha_pareto, edgecolor='none')
    ax.plot(pareto_front_sorted[:min_idx + 1,0], pareto_front_sorted[:min_idx + 1,1], color=colors[1], label='Wing', linewidth=lw_plot, alpha=alpha_pareto)
    if packing_idx == 1:
        ax.hlines(xmin=xmin, xmax=8, y=ymin, color=colors[1])
    ...
    ax.scatter(pareto_front_sorted[:,0][np.argmin(pareto_front_sorted[:,1]) - 1], pareto_front_sorted[:,1][np.argmin(pareto_front_sorted[:,1]) - 1], color=colors[2], edgecolor='none')
    ...
    min_idx = np.argmin(pareto_front_sorted[:,1])
    xmin, ymin = pareto_front_sorted[:,0][min_idx], np.min(pareto_front_sorted[:,1])
    ax.scatter(xmin, ymin, color=colors[2], alpha=alpha_pareto, edgecolor='none')
    ax.plot(pareto_front_sorted[:min_idx + 1,0], pareto_front_sorted[:min_idx + 1,1], color=colors[2], label='Wing', linewidth=lw_plot, alpha=alpha_pareto)
    if packing_idx == 1:
        ax.hlines(xmin=xmin, xmax=8, y=ymin, color=colors[2])
    ...
    min_idx = np.argmin(pareto_front_sorted[:,1])
    xmin, ymin = pareto_front_sorted[:,0][min_idx], np.min(pareto_front_sorted[:,1])
    ax.scatter(xmin, ymin, color=colors[3], alpha=alpha_pareto, edgecolor='none')
    ax.plot(pareto_front_sorted[:min_idx + 1,0], pareto_front_sorted[:min_idx + 1,1], color=colors[3], label='Wing', linewidth=lw_plot, alpha=alpha_pareto)
    if packing_idx == 1:
        ax.hlines(xmin=xmin, xmax=8, y=ymin, color=colors[3])
    # =============================================================================
