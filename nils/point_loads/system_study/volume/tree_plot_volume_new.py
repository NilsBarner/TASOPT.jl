...
Vspec_ref_idx = np.nanargmin(abs(Vspec_unique - Vspec_ref))
...
idx_baseline_nacelle = (0, radius_ref_idx, AR_ref_idx, tdivc_scale_ref_idx, N_eng_ref_idx, HTR_f_ref_idx, minus1, 1, 0)
idx_baseline_wing = (1, radius_ref_idx, AR_ref_idx, tdivc_scale_ref_idx, N_eng_ref_idx, HTR_f_ref_idx, minus1, 1, 0)
idx_baseline_fuselage_1 = (2, radius_ref_idx, AR_ref_idx, tdivc_scale_ref_idx, N_eng_ref_idx, HTR_f_ref_idx, minus1, 0, 0)
idx_baseline_fuselage_2 = (2, radius_ref_idx, AR_ref_idx, tdivc_scale_ref_idx, N_eng_ref_idx, HTR_f_ref_idx, minus1, 1, 0)
...
# ax.scatter(WMTO_ref, CDS_ref, color="red", label="Reference")
# ax.scatter(df_filtered_nacelle["WMTO"], df_filtered_nacelle["CDS"], label="Index starts with 1")
# ax.scatter(df_filtered_wing["WMTO"], df_filtered_wing["CDS"], label="Index starts with 1")
# ax.scatter(df_filtered_fuselage_1["WMTO"], df_filtered_fuselage_1["CDS"], label="Index starts with 1")
# ax.scatter(df_filtered_fuselage_2["WMTO"], df_filtered_fuselage_2["CDS"], label="Index starts with 1")

ax.scatter(df_filtered_N_eng["WMTO"], df_filtered_N_eng["CDS"], label="Index starts with 1")
ax.scatter(df_filtered_HTR_f["WMTO"], df_filtered_HTR_f["CDS"], label="Index starts with 1")

ax.scatter(df_filtered_AR["WMTO"], df_filtered_AR["CDS"], label="Index starts with 1")
ax.scatter(df_filtered_tdivc_scale["WMTO"], df_filtered_tdivc_scale["CDS"], label="Index starts with 1")

ax.scatter(df_filtered_radius_0["WMTO"], df_filtered_radius_0["CDS"], label="Index starts with 1")
ax.scatter(df_filtered_radius_1["WMTO"], df_filtered_radius_1["CDS"], label="Index starts with 1")
