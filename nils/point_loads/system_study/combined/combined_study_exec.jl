...
function analyse_reference_aircraft(ac_segment::String)
    ...
    df = DataFrame(
        ...
        Vol_nacelle = ac_ref.nils.V_fcs_nacelle,  # ac_ref.parg[igVfcsavnacetot],
    ...
    CSV.write("volume_results_narrowbody_ref_101125.csv", df)  # fasts
...
CSV.write("combined_results_narrowbody_101125.csv", df)