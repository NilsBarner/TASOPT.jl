...
ax.scatter(
    WMTO_grid[idx_fcs_loc_des, idx_N_eng_des, idx_wing_frac_des, idx_sigma_fc_des] / WMTO_ref_grid[idx_fcs_loc_des, idx_N_eng_des, idx_wing_frac_des, idx_sigma_fc_des],
    CDS_grid[idx_fcs_loc_des, idx_N_eng_des, idx_wing_frac_des, idx_sigma_fc_des] / CDS_ref_grid[idx_fcs_loc_des, idx_N_eng_des, idx_wing_frac_des, idx_sigma_fc_des],
    marker='o',
    color='black',
    zorder=20,
)
...
for idx_fcs_loc in range(len(fcs_loc_unique)):
    # ax.plot(
    #     WMTO_grid[idx_fcs_loc, idx_N_eng_des, [0, -1], idx_sigma_fc_des] / WMTO_ref_grid[idx_fcs_loc, idx_N_eng_des, [0, -1], idx_sigma_fc_des],
    #     CDS_grid[idx_fcs_loc, idx_N_eng_des, [0, -1], idx_sigma_fc_des] / CDS_ref_grid[idx_fcs_loc, idx_N_eng_des, [0, -1], idx_sigma_fc_des],
    #     color=colors[0],
    #     marker='.',
    # )
    ax.plot(
        WMTO_grid[idx_fcs_loc, idx_N_eng_des, :, idx_sigma_fc_des] / WMTO_ref_grid[idx_fcs_loc, idx_N_eng_des, :, idx_sigma_fc_des],
        CDS_grid[idx_fcs_loc, idx_N_eng_des, :, idx_sigma_fc_des] / CDS_ref_grid[idx_fcs_loc, idx_N_eng_des, :, idx_sigma_fc_des],
        color=colors[0],
    )
...
ax.plot(
    ...
    CDS_grid[idx_fcs_loc_des, :, idx_wing_frac_des, idx_sigma_fc_des] / CDS_ref_grid[idx_fcs_loc_des, :, idx_wing_frac_des, idx_sigma_fc_des],
    color=colors[1],
    marker='.',
)
...
# ax.scatter(
#     WMTO_grid[idx_fcs_loc_des, idx_N_eng_des, :, idx_sigma_fc_des] / WMTO_ref_grid[idx_fcs_loc_des, idx_N_eng_des, :, idx_sigma_fc_des],
#     CDS_grid[idx_fcs_loc_des, idx_N_eng_des, :, idx_sigma_fc_des] / CDS_ref_grid[idx_fcs_loc_des, idx_N_eng_des, :, idx_sigma_fc_des],
#     color=colors[2],
#     marker='.',
# )
...
ax.plot(
    WMTO_grid[idx_fcs_loc_des, idx_N_eng_des, idx_wing_frac_des, :] / WMTO_ref_grid[idx_fcs_loc_des, idx_N_eng_des, idx_wing_frac_des, :],
    CDS_grid[idx_fcs_loc_des, idx_N_eng_des, idx_wing_frac_des, :] / CDS_ref_grid[idx_fcs_loc_des, idx_N_eng_des, idx_wing_frac_des, :],
    color=colors[3],
    marker='.',
)
